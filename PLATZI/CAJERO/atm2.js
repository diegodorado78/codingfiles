...
caja.push(new Billete(20,30,20));
...
//estas lineas siguientes estan por fuera del ciclo porque a este punto ya gaste todos los billetes
  ...
  {
    resultado.innerHTML += e.cantidad +  'billetes de' + e.valor  + "<br />" + resultado.appendChild(e.imagen)
console.log(document.body.appendChild(e.imagen));
